...
/**
 * BQEmploymentRelatedProceduresandGuidelinesInitiateOutputModel
 */
public class BQEmploymentRelatedProceduresandGuidelinesInitiateOutputModel   {
  private String employmentRelatedProceduresandGuidelinesInstanceReference = null;

  private String employmentRelatedProceduresandGuidelinesInitiateActionReference = null;

  private Object employmentRelatedProceduresandGuidelinesInitiateActionRecord = null;

  private String employmentRelatedProceduresandGuidelinesInstanceStatus = null;
  ...
  **/
   ...
   * @return employmentRelatedProceduresandGuidelinesInitiateActionReference
  **/

  public String getEmploymentRelatedProceduresandGuidelinesInitiateActionReference() {
    return employmentRelatedProceduresandGuidelinesInitiateActionReference;
  }

  public void setEmploymentRelatedProceduresandGuidelinesInitiateActionReference(String employmentRelatedProceduresandGuidelinesInitiateActionReference) {
    this.employmentRelatedProceduresandGuidelinesInitiateActionReference = employmentRelatedProceduresandGuidelinesInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Employment Related Procedures and Guidelines instance (e.g. initialised, pending, active) 
   * @return employmentRelatedProceduresandGuidelinesInstanceStatus
  **/

  public String getEmploymentRelatedProceduresandGuidelinesInstanceStatus() {
    return employmentRelatedProceduresandGuidelinesInstanceStatus;
  }

  public void setEmploymentRelatedProceduresandGuidelinesInstanceStatus(String employmentRelatedProceduresandGuidelinesInstanceStatus) {
    this.employmentRelatedProceduresandGuidelinesInstanceStatus = employmentRelatedProceduresandGuidelinesInstanceStatus;
  }
