...
/**
 * BQCompanyMissionandPoliciesInitiateOutputModel
 */
public class BQCompanyMissionandPoliciesInitiateOutputModel   {
  private String companyMissionandPoliciesInstanceReference = null;

  private String companyMissionandPoliciesInitiateActionReference = null;

  private Object companyMissionandPoliciesInitiateActionRecord = null;

  private String companyMissionandPoliciesInstanceStatus = null;
  ...
  **/
   ...
   * @return companyMissionandPoliciesInitiateActionReference
  **/

  public String getCompanyMissionandPoliciesInitiateActionReference() {
    return companyMissionandPoliciesInitiateActionReference;
  }

  public void setCompanyMissionandPoliciesInitiateActionReference(String companyMissionandPoliciesInitiateActionReference) {
    this.companyMissionandPoliciesInitiateActionReference = companyMissionandPoliciesInitiateActionReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The Initiate service call input and output record 
   * @return companyMissionandPoliciesInitiateActionRecord
  **/

  public Object getCompanyMissionandPoliciesInitiateActionRecord() {
    return companyMissionandPoliciesInitiateActionRecord;
  }

  public void setCompanyMissionandPoliciesInitiateActionRecord(Object companyMissionandPoliciesInitiateActionRecord) {
    this.companyMissionandPoliciesInitiateActionRecord = companyMissionandPoliciesInitiateActionRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Company Mission and Policies instance (e.g. initialised, pending, active) 
   * @return companyMissionandPoliciesInstanceStatus
  **/

  public String getCompanyMissionandPoliciesInstanceStatus() {
    return companyMissionandPoliciesInstanceStatus;
  }

  public void setCompanyMissionandPoliciesInstanceStatus(String companyMissionandPoliciesInstanceStatus) {
    this.companyMissionandPoliciesInstanceStatus = companyMissionandPoliciesInstanceStatus;
  }
