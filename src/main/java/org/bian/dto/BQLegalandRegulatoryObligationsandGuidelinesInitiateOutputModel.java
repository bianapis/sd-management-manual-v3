...
/**
 * BQLegalandRegulatoryObligationsandGuidelinesInitiateOutputModel
 */
public class BQLegalandRegulatoryObligationsandGuidelinesInitiateOutputModel   {
  private String legalandRegulatoryObligationsandGuidelinesInstanceReference = null;

  private String legalandRegulatoryObligationsandGuidelinesInitiateActionReference = null;

  private Object legalandRegulatoryObligationsandGuidelinesInitiateActionRecord = null;

  private String legalandRegulatoryObligationsandGuidelinesInstanceStatus = null;
  ...
  **/
   ...
   * @return legalandRegulatoryObligationsandGuidelinesInitiateActionReference
  **/

  public String getLegalandRegulatoryObligationsandGuidelinesInitiateActionReference() {
    return legalandRegulatoryObligationsandGuidelinesInitiateActionReference;
  }

  public void setLegalandRegulatoryObligationsandGuidelinesInitiateActionReference(String legalandRegulatoryObligationsandGuidelinesInitiateActionReference) {
    this.legalandRegulatoryObligationsandGuidelinesInitiateActionReference = legalandRegulatoryObligationsandGuidelinesInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Legal and Regulatory Obligations and Guidelines instance (e.g. initialised, pending, active) 
   * @return legalandRegulatoryObligationsandGuidelinesInstanceStatus
  **/

  public String getLegalandRegulatoryObligationsandGuidelinesInstanceStatus() {
    return legalandRegulatoryObligationsandGuidelinesInstanceStatus;
  }

  public void setLegalandRegulatoryObligationsandGuidelinesInstanceStatus(String legalandRegulatoryObligationsandGuidelinesInstanceStatus) {
    this.legalandRegulatoryObligationsandGuidelinesInstanceStatus = legalandRegulatoryObligationsandGuidelinesInstanceStatus;
  }
